...
class OutfitList extends React.Component {
  ...
  render() {
    const {
      leftCordinate, slideLength, leftArrowVisibility, rightArrowVisibility,
    } = this.state;
    const {
      selectProductId, selectAnotherProduct, addNewOutfit, deleteOutfit, userOutfits,
    } = this.props;
    return (
      <div className="outfitList">
        <span className="leftArrow" tabIndex={0} role="button" style={{ visibility: leftArrowVisibility }} onKeyPress={this.moveToPrevCard} onClick={this.moveToPrevCard}><i className="fas fa-arrow-left" alt="left-arrow" style={{ width: '30px', height: '30px' }} /></span>
        ...
        <span className="rightArrow" tabIndex={0} role="button" style={{ visibility: rightArrowVisibility }} onKeyPress={this.moveToNextCard} onClick={this.moveToNextCard}><i className="fas fa-arrow-right" alt="right-arrow" style={{ width: '30px', height: '30px' }} /></span>
      </div>
    );
  }
}
