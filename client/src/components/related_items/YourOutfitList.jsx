    ...
    <div className="product-list">
      ...
      >
        <Slider className="carousel__slider">
          ...
          >
            <div data-testid="addition-card" className="product-card add-card" onClick={(_event) => addNewOutfitClick(product_id)} onKeyDown={(_event) => addNewOutfitClick(product_id)}>
              <PlusCircle
                size={55}
                style={{
                  display: 'block',
