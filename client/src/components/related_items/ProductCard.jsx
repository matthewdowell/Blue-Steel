...
import { exampleStyleData } from './exampleStyleData.js';
...
class ProductCard extends React.Component {
  constructor(props) {
    ...
    this.state = {
      window: 'none',
      productStyles: exampleStyleData,
      currentStyle: exampleStyleData[0],
      productInfo: {
        id: 17810,
        campus: null,
        name: null,
  ...
  render() {
    const {
      selectProductInfo, selectAnotherProduct, isRelated, deleteOutfit, productId,
    } = this.props;
    const {
      window, productInfo, currentStyle, averageRating, commonFeatures,
    } = this.state;
    return (
