...
import {
  getProducts, getProductsById, getRelatedProducts, getStyles,
  ...
  return (
    ...
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ border: 'none', width: '80%' }}>
        ...
        <div style={{
          display: 'flex', width: '100%', background: 'none', maxHeight: '700px', overflow: 'hidden',
        }}
        >
          <ImageGallery
        ...
        <div style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-around', width: '100%', background: 'none', minHeight: '200px',
        }}
        >
